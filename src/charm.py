...
class SupersetK8SCharm(TypedCharmBase[CharmConfig]):
    ...
    def _create_env(self):
        ...
        env = {
            ...
            "SMTP_EMAIL": self.config["smtp-email"],
            # TODO: this should come from Redis
            "SMTP_SUPERSET_INTERNAL_URL": None,
            "SMTP_SUPERSET_URL": self.config["smtp-superset-url"],
            "SMTP_SSL": self.config["smtp-ssl"],
            "SMTP_STARTTLS": self.config["smtp-start-tls"],
            "SMTP_SSL_SERVER_AUTH": self.config["smtp-ssl-server-auth"],
