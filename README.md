...
## Backup and restore
### Setting up storage
Apache Superset is a stateless application, all of the metadata is stored in the PostgreSQL relation. Therefore backup and restore is achieved through backup and restoration of this data. A requirement for this is an S3 bucket for use with the [S3 integrator charm](https://charmhub.io/s3-integrator).
...
In order to create backups you must have scaled PostgreSQL to at least 3 nodes.
```
# Scale postgresql charm to 3 units
